...
export default function HeroSection () {
  ...
  return (
    <div
      ref={containerRef}
      className='min-h-screen flex items-center justify-center relative overflow-hidden  md:pt-20'
    >
      ...
      >
        <motion.div
          variants={item}
          animate='active'
          className='mb-16 -mt-36 md:mt-0'
        >
          <div className='group inline-block px-4 py-2 rounded-full bg-white/5 backdrop-blur-sm border border-slate-200 mb-6 dark:border-cyan-500/30 dark:bg-indigo-900/30  dark:text-slate-300  dark:hover:bg-indigo-800/40 dark:hover:border-cyan-300 transition-all'>
            <p className='text-[10px] md:text-sm text-white dark:text-cyan-400 font-medium dark:hover:bg-gradient-to-r dark:hover:from-cyan-300 dark:hover:to-cyan-300 dark:hover:bg-clip-text dark:hover:text-transparent dark:hover:border-cyan-300'>
              Full-Stack MERN Engineer • 1.5+ years building production apps
            </p>
          </div>
        </motion.div>
        ...
        <motion.div
          variants={item}
          className='btn-group-responsive gap-4  md:gap-8 flex justify-center'
        >
          <motion.button
          ...
          <motion.button
            ...
            className='group px-3 py-2 rounded-lg bg-transparent text-white border-2 border-indigo-300 dark:border-indigo-700 dark:bg-indigo-900/30  dark:text-indigo-700
  dark:hover:bg-indigo-800/40 font-semibold dark:hover:border-cyan-300 dark:hover:text-cyan-300 transition-all hover:bg-indigo-200 duration-200 flex items-center gap-2 shadow-sm hover:shadow-md'
